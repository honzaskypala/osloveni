...
def generateReturn(fout):
    ...
    fout.write(config["indent"] * 2 + config["return"].format(exp=config["leftstr"].format(var=config["var"].format(varname="jmeno"), length=("-" + config["strlen"].format(var=config["var"].format(varname="replacepair") + "[0]")) if config["strnegativepos"] else (config["strlen"].format(var=config["var"].format(varname="jmeno")) + " - " + config["strlen"].format(var=config["var"].format(varname="replacepair") + "[0]")))) + "\n")
    ...
    fout.write(config["indent"] * 2 + config["return"].format(exp=config["concat"].format(str1=config["var"].format(varname="jmeno"), str2="(" + config["conditional"].format(cond=config["islowercase"].format(var=config["charatpos"].format(var=config["var"].format(varname="jmeno"), pos="-1" if config["strnegativepos"] else config["strlen"].format(var=config["var"].format(varname="jmeno")) + " - 1")), exp1=config["var"].format(varname="replacepair") + "[1]", exp2=config["uppercase"].format(var=config["var"].format(varname="replacepair") + "[1]")) + ")")) + "\n")
