                    ...
                    if "switch" in config and len(suffixLeafs) > 2:
                        if "casemultiseparator" in config:
                            ...
                            for i in range(1, len(sufList)):
                                exp += config["casemultiseparator"] + config["charquote"] + sufList[i] + config["charquote"]
                            fout.write(indent + config["case"].format(exp=exp) + "\n")
                        else:
                            for suf1 in sufList:
...
def generateReturn(fout):
    fout.write("\n")
    fout.write(config["indent"] + config["if"].format(cond=config["and"].format(exp1=config["equal"].format(exp1=config["var"].format(varname="replacepair") + config["tupleindex"].format(index="0"), exp2=config["strquote"] * 2), exp2=config["equal"].format(exp1=config["var"].format(varname="replacepair") + config["tupleindex"].format(index="1"), exp2=config["strquote"] * 2))) + "\n")
    fout.write(config["indent"] * 2 + config["return"].format(exp=config["var"].format(varname="jmeno")) + "\n")
    fout.write(config["indent"] + config["elseif"].format(cond=config["equal"].format(exp1=config["var"].format(varname="replacepair") + config["tupleindex"].format(index="1"), exp2=config["strquote"] * 2)) + "\n")
    fout.write(config["indent"] * 2 + config["return"].format(exp=config["leftstr"].format(var=config["var"].format(varname="jmeno"), length=("-" + config["strlen"].format(var=config["var"].format(varname="replacepair") + config["tupleindex"].format(index="0"))) if config["strnegativepos"] else (config["strlen"].format(var=config["var"].format(varname="jmeno")) + " - " + config["strlen"].format(var=config["var"].format(varname="replacepair") + config["tupleindex"].format(index="0"))))) + "\n")
    fout.write(config["indent"] + config["elseif"].format(cond=config["equal"].format(exp1=config["var"].format(varname="replacepair") + config["tupleindex"].format(index="0"), exp2=config["strquote"] * 2)) + "\n")
    fout.write(config["indent"] * 2 + config["return"].format(exp=config["concat"].format(str1=config["var"].format(varname="jmeno"), str2="(" + config["conditional"].format(cond=config["islowercase"].format(var=config["charatpos"].format(var=config["var"].format(varname="jmeno"), pos="-1" if config["strnegativepos"] else config["strlen"].format(var=config["var"].format(varname="jmeno")) + " - 1")), exp1=config["var"].format(varname="replacepair") + config["tupleindex"].format(index="1"), exp2=config["uppercase"].format(var=config["var"].format(varname="replacepair") + config["tupleindex"].format(index="1"))) + ")")) + "\n")
    fout.write(config["indent"] + config["else"] + "\n")
    if "vardeclaration" in config:
        fout.write(config["indent"] * 2 + config["vardeclaration"].format(var=config["var"].format(varname="replaceending"), type=config["vartypestring"] if "vartypestring" in config else "") + "\n")
    fout.write(config["indent"] * 2 + config["assignement"].format(var=config["var"].format(varname="replaceending"), exp=config["rightstr"].format(var=config["var"].format(varname="jmeno"), length=config["strlen"].format(var=config["var"].format(varname="replacepair") + config["tupleindex"].format(index="0")))) + "\n")
    fout.write(config["indent"] * 2 + config["if"].format(cond=config["isuppercase"].format(var=config["var"].format(varname="replaceending"))) + "\n")
    fout.write(config["indent"] * 3 + config["return"].format(exp=config["concat"].format(str1=config["leftstr"].format(var=config["var"].format(varname="jmeno"), length=("-" + config["strlen"].format(var=config["var"].format(varname="replacepair") + config["tupleindex"].format(index="0")) if config["strnegativepos"] else config["strlen"].format(var=config["var"].format(varname="jmeno")) + " - "  + config["strlen"].format(var=config["var"].format(varname="replacepair") + config["tupleindex"].format(index="0")))), str2=config["uppercase"].format(var=config["var"].format(varname="replacepair") + config["tupleindex"].format(index="1")))) + "\n")
    ...
    fout.write(config["indent"] * 3 + config["return"].format(exp=config["concat"].format(str1=config["leftstr"].format(var=config["var"].format(varname="jmeno"), length=("-" + config["strlen"].format(var=config["var"].format(varname="replacepair") + config["tupleindex"].format(index="0")) if config["strnegativepos"] else config["strlen"].format(var=config["var"].format(varname="jmeno")) + " - "  + config["strlen"].format(var=config["var"].format(varname="replacepair") + config["tupleindex"].format(index="0")))), str2=config["titlecase"].format(var=config["var"].format(varname="replacepair") + config["tupleindex"].format(index="1")))) + "\n")
    ...
    fout.write(config["indent"] * 3 + config["return"].format(exp=config["concat"].format(str1=config["leftstr"].format(var=config["var"].format(varname="jmeno"), length=("-" + config["strlen"].format(var=config["var"].format(varname="replacepair") + config["tupleindex"].format(index="0")) if config["strnegativepos"] else config["strlen"].format(var=config["var"].format(varname="jmeno")) + " - "  + config["strlen"].format(var=config["var"].format(varname="replacepair") + config["tupleindex"].format(index="0")))), str2=config["var"].format(varname="replacepair") + config["tupleindex"].format(index="1"))) + "\n")
    if "endif" in config:
